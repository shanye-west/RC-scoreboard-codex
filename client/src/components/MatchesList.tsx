  ...
  const renderMatchResult = (match: Match) => {
    if (match.status === "completed" && match.result) {
      const winningTeam = match.leadingTeam === "aviators" 
        ? <img src={aviatorsText} alt="Aviators" className="h-5 inline-block" /> 
        : <img src={producersText} alt="Producers" className="h-5 inline-block" />;
            ...
            <div className="flex mb-2">
              <div className="w-1/2 border-r border-gray-200 pr-3">
                <div className="flex items-center mb-1">
                  <img src={aviatorsText} alt="Aviators" className="h-5 mr-2" />
                </div>
              ...
              <div className="w-1/2 pl-3">
                <div className="flex items-center justify-end mb-1">
                  <img src={producersText} alt="Producers" className="h-5 ml-2" />
                </div>
